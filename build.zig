...
pub fn build(b: *std.Build) void {
    ...
    const debasm_exe = b.addExecutable(.{
        .name = "debasm",
        .root_module = b.createModule(.{
            .root_source_file = b.path("debasm/main.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "bm", .module = bm_mod },
